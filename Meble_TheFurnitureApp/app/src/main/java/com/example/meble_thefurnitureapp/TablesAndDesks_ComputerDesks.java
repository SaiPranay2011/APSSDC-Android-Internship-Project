...
public class TablesAndDesks_ComputerDesks extends AppCompatActivity implements PaymentResultListener {
    ...
    public void Buy_cd1(View view) {
        ...
        try {
            JSONObject object = new JSONObject();
            object.put("Name","Delrick Wooden Computer Desk");
    ...
    public void Buy_cd2(View view) {
        ...
        try {
            JSONObject object = new JSONObject();
            object.put("Name","Plutus Wooden Computer Desk");
    ...
    public void Buy_cd3(View view) {
        ...
        try {
            JSONObject object = new JSONObject();
            object.put("Name","Seoul Wooden Computer Desk");
    ...
    public void Buy_cd4(View view) {
        ...
        try {
            JSONObject object = new JSONObject();
            object.put("Name","Voyager Computer Desk in Stainless Steel");
