...
public final class ActivityBedsChildrensBedsBinding implements ViewBinding {
  ...
  private ActivityBedsChildrensBedsBinding(@NonNull ScrollView rootView, @NonNull Toolbar toolbar) {
  ...
  public static ActivityBedsChildrensBedsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBedsChildrensBedsBinding((ScrollView) rootView, toolbar);
    }
