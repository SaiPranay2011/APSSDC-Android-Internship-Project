...
public final class AppBarHomePageBinding implements ViewBinding {
  ...
  private AppBarHomePageBinding(@NonNull CoordinatorLayout rootView, @NonNull Toolbar toolbar) {
  ...
  public static AppBarHomePageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AppBarHomePageBinding((CoordinatorLayout) rootView, toolbar);
    }
