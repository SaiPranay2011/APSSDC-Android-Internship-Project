...
public final class ActivityChairsBenchesBinding implements ViewBinding {
  ...
  private ActivityChairsBenchesBinding(@NonNull ScrollView rootView, @NonNull Toolbar toolbar) {
  ...
  public static ActivityChairsBenchesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityChairsBenchesBinding((ScrollView) rootView, toolbar);
    }
